...
// GROUP1 stands for the data obatined from ADS1256.
#define PACKET_HEADER_GROUP1_META_SIZE	1		// It is the size in bytes of the meta information between the 4-bytes header and the actual sampled signal, i.e. |(4bytes)|PACKET_HEADER_GROUP1_META_SIZE|buff_data
#define PACKET_HEADER_GROUP1_A_SAMPLE_SIZE_IN_BYTES 3 // Size of a sample in group1 in a unit of bytes.
