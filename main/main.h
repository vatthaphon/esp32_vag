...
////////// Device information. //////////
#define MANUFACTURER_NAME     	"F.I.R.S.T"
#define MODEL_NUMBER			"1.0"
#define SERIAL_NUMBER 			"0.0.1"
#define HARDWARE_REVISION		"1.0"
#define FIRMWARE_REVISION		"0.1"

////////// Options for setting funtionality of i-Aware. //////////
// #define READ_SAMPLING_FREQUENCY_FROM_FLASH
// #define WRITE_SAMPLING_FREQUENCY_FROM_FLASH

#define DSP_POWER_FREQ_BANDS_ENABLE
...
extern char *IAWARE_DSP;
// #define ESP_LOG_LEVEL_IAWARE_DSP  ESP_LOG_WARN
#define ESP_LOG_LEVEL_IAWARE_DSP  ESP_LOG_INFO
...
extern struct buff_node *run_dsp_buff_node_ptr;
extern struct buff_node *run_dsp_buff_node_pre_ptr;

extern char iaware_device_name[];
