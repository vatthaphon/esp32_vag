...
if __name__ == "__main__":
    ...
    # iaware_l.createTCPClient(buff_socket_size_p=4096, server_ip_p="192.168.4.1", server_port_p=5000, Fs_senddata_p=20, Fs_p=20000, Name_p="iAwareClient")
    ...
    # idx_samples_l, samples_l = iaware_l.getRawData()    

    # print(samples_l)

    # plt.plot(samples_l[0, :])
    ...
    while (True):
        ...
        # print( str(time.ctime()) + ":" + str(iaware_l.getEffSamplingFreq()) + ", total samples since last call:" + str(iaware_l.getTotalSamples()) )
        print( str(time.ctime()) + ":" + str(iaware_l.getASample()) )
